...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[2] = { A16, A10,  };
		...
		case T2: {
			const enum vertices next[3] = { A12, A16, A14,  };
		...
		case T3: {
			const enum vertices next[5] = { T1, T1, T1, A15, T0,  };
		...
		case T5: {
			const enum vertices next[3] = { T1, T2, A16,  };
		...
		case T6: {
			const enum vertices next[2] = { T4, T2,  };
		...
		case T7: {
			const enum vertices next[3] = { T6, T5, T3,  };
		...
		case T8: {
			const enum vertices next[7] = { T2, T7, T6, T3, T2, A11, A11,  };
