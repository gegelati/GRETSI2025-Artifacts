...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[2] = { A14, A10,  };
		...
		case T1: {
			const enum vertices next[4] = { A15, A13, A14, A10,  };
		...
		case T2: {
			const enum vertices next[2] = { A16, A11,  };
		...
		case T3: {
			const enum vertices next[4] = { A11, A10, T0, A16,  };
		...
		case T4: {
			const enum vertices next[4] = { T2, A11, T1, A10,  };
		...
		case T5: {
			const enum vertices next[3] = { A16, T4, T3,  };
		...
		case T7: {
			const enum vertices next[4] = { T5, T2, T6, T3,  };
		...
		case T8: {
			const enum vertices next[4] = { T6, T7, A11, T2,  };
		...
		case T9: {
			const enum vertices next[7] = { T3, A12, T8, T7, T4, T6, A13,  };
