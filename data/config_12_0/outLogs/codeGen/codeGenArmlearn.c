...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[3] = { A15, A17, A14,  };
		...
		case T2: {
			const enum vertices next[3] = { A16, A14, A15,  };
		...
		case T4: {
			const enum vertices next[5] = { A17, A14, A17, A15, T2,  };
		...
		case T5: {
			const enum vertices next[3] = { T2, A16, A16,  };
		...
		case T7: {
			const enum vertices next[3] = { A12, T1, T5,  };
		...
		case T8: {
			const enum vertices next[4] = { T4, T3, T6, A11,  };
		...
		case T9: {
			const enum vertices next[4] = { T4, A11, A11, T4,  };
		...
		case T10: {
			const enum vertices next[7] = { T9, A11, T3, T7, A14, T8, T6,  };
