...
int inferenceTPG() {
	...
	while(1) {
		...
		case T2: {
			const enum vertices next[4] = { A17, A14, A13, A16,  };
		...
		case T3: {
			const enum vertices next[4] = { A17, A14, A14, A19,  };
		...
		case T5: {
			const enum vertices next[4] = { A19, T0, T3, A20,  };
		...
		case T6: {
			const enum vertices next[4] = { T2, A13, T4, T5,  };
		...
		case T9: {
			const enum vertices next[5] = { T7, T6, A19, T2, T1,  };
		...
		case T10: {
			const enum vertices next[3] = { T2, T9, A18,  };
		...
		case T11: {
			const enum vertices next[2] = { T8, A18,  };
