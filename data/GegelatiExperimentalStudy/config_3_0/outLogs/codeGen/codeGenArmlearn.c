...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[2] = { A18, A11,  };
		...
		case T2: {
			const enum vertices next[5] = { A13, A17, A16, A11, A13,  };
		...
		case T3: {
			const enum vertices next[4] = { A17, T0, A15, T2,  };
		...
		case T6: {
			const enum vertices next[3] = { A15, T2, T5,  };
		...
		case T8: {
			const enum vertices next[5] = { A15, A14, A16, T6, A12,  };
		...
		case T9: {
			const enum vertices next[7] = { T6, T2, T4, T1, A15, A17, A14,  };
		...
		case T10: {
			const enum vertices next[3] = { T7, T8, T9,  };
