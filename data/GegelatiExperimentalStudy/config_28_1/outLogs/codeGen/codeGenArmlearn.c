...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[3] = { A13, A14, A13,  };
		...
		case T1: {
			const enum vertices next[2] = { A11, A16,  };
		...
		case T2: {
			const enum vertices next[4] = { A16, A11, A15, A11,  };
		...
		case T5: {
			const enum vertices next[5] = { A11, A16, A11, T4, A11,  };
		...
		case T6: {
			const enum vertices next[4] = { T4, T3, A16, A10,  };
		...
		case T7: {
			const enum vertices next[3] = { A10, A11, A13,  };
		...
		case T8: {
			const enum vertices next[2] = { A16, T7,  };
		...
		case T9: {
			const enum vertices next[6] = { T5, T8, T0, T6, T5, A16,  };
