...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[3] = { A13, A13, A15,  };
		...
		case T3: {
			const enum vertices next[5] = { A14, A13, A13, T2, T0,  };
		...
		case T4: {
			const enum vertices next[4] = { A11, A14, A16, A12,  };
		...
		case T5: {
			const enum vertices next[3] = { T3, A15, T0,  };
		...
		case T6: {
			const enum vertices next[5] = { A14, A13, A11, T2, A16,  };
		...
		case T7: {
			const enum vertices next[2] = { T6, A11,  };
		...
		case T8: {
			const enum vertices next[3] = { T4, T5, T7,  };
		...
		case T9: {
			const enum vertices next[5] = { T8, T5, T4, T8, T7,  };
		...
		case T10: {
			const enum vertices next[3] = { A12, T7, T9,  };
