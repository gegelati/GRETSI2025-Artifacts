...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[3] = { T0, A10, A14,  };
		...
		case T2: {
			const enum vertices next[3] = { A8, A8, A10,  };
		...
		case T3: {
			const enum vertices next[4] = { A11, A8, A13, A10,  };
		...
		case T5: {
			const enum vertices next[3] = { T4, T2, T1,  };
		...
		case T7: {
			const enum vertices next[6] = { T6, T4, A9, T4, A15, A15,  };
