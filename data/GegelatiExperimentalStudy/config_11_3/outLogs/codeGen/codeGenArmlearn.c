...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[2] = { A10, A7,  };
		...
		case T2: {
			const enum vertices next[3] = { A9, A7, A11,  };
		...
		case T5: {
			const enum vertices next[5] = { A11, A12, A7, A9, A8,  };
		...
		case T6: {
			const enum vertices next[6] = { T4, T0, T3, A12, A13, T5,  };
