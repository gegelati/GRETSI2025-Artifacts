...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[2] = { A10, A13,  };
		...
		case T3: {
			const enum vertices next[3] = { A9, T2, T2,  };
		...
		case T4: {
			const enum vertices next[3] = { A8, A7, A9,  };
		...
		case T5: {
			const enum vertices next[3] = { T4, T3, T0,  };
		...
		case T6: {
			const enum vertices next[6] = { T4, T5, A11, A12, T1, A11,  };
