...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[7] = { A11, A10, A11, A14, A9, A10, A11,  };
		...
		case T2: {
			const enum vertices next[3] = { A9, T1, T1,  };
		...
		case T3: {
			const enum vertices next[7] = { A11, A15, A11, A14, A10, A10, A9,  };
		...
		case T5: {
			const enum vertices next[5] = { A15, T1, A10, T0, T4,  };
		...
		case T6: {
			const enum vertices next[3] = { A10, T5, T3,  };
		...
		case T7: {
			const enum vertices next[4] = { A15, T0, T4, T3,  };
		...
		case T8: {
			const enum vertices next[9] = { A15, A10, A10, T7, T1, T6, A14, T3, A10,  };
