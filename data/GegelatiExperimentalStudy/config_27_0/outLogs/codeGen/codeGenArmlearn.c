...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[2] = { A15, A15,  };
		...
		case T3: {
			const enum vertices next[3] = { A12, A14, A17,  };
		...
		case T4: {
			const enum vertices next[2] = { A17, T0,  };
		...
		case T5: {
			const enum vertices next[5] = { A13, A14, A12, A11, A11,  };
		...
		case T6: {
			const enum vertices next[4] = { A18, A13, A11, T2,  };
		...
		case T7: {
			const enum vertices next[4] = { A11, T3, T1, A18,  };
		...
		case T9: {
			const enum vertices next[4] = { T8, T5, A16, A17,  };
		...
		case T10: {
			const enum vertices next[4] = { T7, T8, T9, T4,  };
