...
enum vertices {T0, T1, T2, T3, T4, T5, T6, T7, A8, A9, A10, A11, A12, A13, A14, A15, A16, };
...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[2] = { A13, A8,  };
		...
		case T3: {
			const enum vertices next[4] = { A9, T1, A12, T2,  };
		...
		case T4: {
			const enum vertices next[4] = { A9, A16, A8, A15,  };
		...
		case T6: {
			const enum vertices next[3] = { T5, T5, T0,  };
