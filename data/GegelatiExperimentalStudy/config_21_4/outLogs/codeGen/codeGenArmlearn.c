...
int inferenceTPG() {
	...
	while(1) {
		...
		case T4: {
			const enum vertices next[3] = { T3, A15, A16,  };
		...
		case T5: {
			const enum vertices next[2] = { T4, A17,  };
		...
		case T6: {
			const enum vertices next[3] = { T2, A11, A16,  };
		...
		case T8: {
			const enum vertices next[4] = { A11, T0, T5, T1,  };
		...
		case T9: {
			const enum vertices next[4] = { A11, T7, T1, T0,  };
		...
		case T10: {
			const enum vertices next[6] = { T7, T9, A14, T8, T5, T6,  };
