...
int inferenceTPG() {
	...
	while(1) {
		...
		case T2: {
			const enum vertices next[2] = { A9, A12,  };
		...
		case T4: {
			const enum vertices next[4] = { A8, T3, A11, A12,  };
		...
		case T5: {
			const enum vertices next[5] = { T2, A8, A7, A11, A7,  };
		...
		case T6: {
			const enum vertices next[3] = { T5, T4, T5,  };
