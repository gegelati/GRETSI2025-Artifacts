...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[2] = { A13, A13,  };
		...
		case T1: {
			const enum vertices next[3] = { A10, A12, A13,  };
		...
		case T4: {
			const enum vertices next[6] = { A12, A13, A14, A12, T1, A10,  };
		...
		case T5: {
			const enum vertices next[7] = { A10, A9, A13, T2, A9, A10, A10,  };
		...
		case T7: {
			const enum vertices next[4] = { T3, A10, T5, T0,  };
		...
		case T8: {
			const enum vertices next[4] = { T0, T7, A12, T6,  };
