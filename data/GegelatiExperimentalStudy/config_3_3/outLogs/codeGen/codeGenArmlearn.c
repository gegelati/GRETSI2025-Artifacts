...
int inferenceTPG() {
	...
	while(1) {
		...
		case T2: {
			const enum vertices next[3] = { T1, A14, A11,  };
		...
		case T3: {
			const enum vertices next[3] = { A14, T2, A10,  };
		...
		case T4: {
			const enum vertices next[3] = { T2, T0, T3,  };
		...
		case T5: {
			const enum vertices next[3] = { T4, A14, T0,  };
		...
		case T6: {
			const enum vertices next[3] = { T2, T0, T4,  };
		...
		case T7: {
			const enum vertices next[3] = { T5, T6, T4,  };
		...
		case T8: {
			const enum vertices next[3] = { T3, T7, T1,  };
