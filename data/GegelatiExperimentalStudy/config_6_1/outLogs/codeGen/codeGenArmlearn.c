...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[3] = { A12, A13, A9,  };
		...
		case T2: {
			const enum vertices next[4] = { A11, T0, A13, A10,  };
		...
		case T3: {
			const enum vertices next[6] = { A10, T0, A11, A13, T0, T1,  };
		...
		case T4: {
			const enum vertices next[6] = { A12, A13, T0, A10, A11, T1,  };
		...
		case T8: {
			const enum vertices next[6] = { T3, T5, T7, T4, A12, T6,  };
