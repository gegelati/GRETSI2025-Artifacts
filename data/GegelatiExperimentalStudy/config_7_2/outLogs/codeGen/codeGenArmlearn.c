...
int inferenceTPG() {
	...
	while(1) {
		...
		case T2: {
			const enum vertices next[4] = { T0, A17, A15, A15,  };
		...
		case T3: {
			const enum vertices next[3] = { A15, A12, A14,  };
		...
		case T7: {
			const enum vertices next[4] = { A13, A17, T5, T5,  };
		...
		case T8: {
			const enum vertices next[3] = { T3, T2, T4,  };
		...
		case T9: {
			const enum vertices next[4] = { T7, T8, T6, T2,  };
		...
		case T10: {
			const enum vertices next[2] = { A16, T9,  };
