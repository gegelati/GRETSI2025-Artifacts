...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[3] = { A9, A8, A10,  };
		...
		case T1: {
			const enum vertices next[4] = { A12, A8, A11, A7,  };
		...
		case T2: {
			const enum vertices next[3] = { T1, A9, A11,  };
		...
		case T4: {
			const enum vertices next[4] = { T1, T2, A11, A7,  };
		...
		case T5: {
			const enum vertices next[4] = { A7, T0, T2, T3,  };
		...
		case T6: {
			const enum vertices next[3] = { T5, T4, A13,  };
