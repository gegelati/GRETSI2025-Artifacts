...
enum vertices {T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, A13, A14, A15, A16, A17, A18, A19, A20, A21, };
...
int inferenceTPG() {
	...
	while(1) {
		...
		case T2: {
			const enum vertices next[3] = { A18, A17, A17,  };
		...
		case T4: {
			const enum vertices next[4] = { T2, A20, A17, A18,  };
		...
		case T5: {
			const enum vertices next[4] = { A20, A17, A13, A15,  };
		...
		case T7: {
			const enum vertices next[2] = { T4, A20,  };
		...
		case T8: {
			const enum vertices next[3] = { T1, T3, A20,  };
		...
		case T9: {
			const enum vertices next[3] = { T1, A18, A17,  };
		...
		case T10: {
			const enum vertices next[5] = { A18, T5, T9, A21, T8,  };
		...
		case T11: {
			const enum vertices next[3] = { A15, T10, A21,  };
		...
		case T12: {
			const enum vertices next[7] = { T5, A14, T7, T11, A21, A18, T6,  };
