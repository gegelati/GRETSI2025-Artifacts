...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[2] = { A18, A16,  };
		...
		case T3: {
			const enum vertices next[3] = { A13, A19, A17,  };
		...
		case T5: {
			const enum vertices next[3] = { T1, A16, T3,  };
		...
		case T6: {
			const enum vertices next[4] = { T2, T0, A14, A13,  };
		...
		case T7: {
			const enum vertices next[4] = { T2, T0, A17, T6,  };
		...
		case T8: {
			const enum vertices next[4] = { T7, T6, A13, T5,  };
		...
		case T9: {
			const enum vertices next[4] = { A13, A16, T4, A18,  };
		...
		case T10: {
			const enum vertices next[5] = { T8, T4, A14, T2, T9,  };
		...
		case T11: {
			const enum vertices next[6] = { T2, T8, A14, T9, T8, T2,  };
		...
		case T12: {
			const enum vertices next[8] = { T10, A14, T2, T11, A13, A15, T9, T4,  };
