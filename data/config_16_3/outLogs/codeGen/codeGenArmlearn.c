...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[3] = { A10, A9, A12,  };
		...
		case T2: {
			const enum vertices next[4] = { A11, T0, A14, A12,  };
		...
		case T3: {
			const enum vertices next[2] = { T1, A11,  };
		...
		case T4: {
			const enum vertices next[2] = { A13, T3,  };
		...
		case T5: {
			const enum vertices next[4] = { T3, A11, T3, A13,  };
		...
		case T6: {
			const enum vertices next[4] = { A11, T4, A13, T3,  };
		...
		case T8: {
			const enum vertices next[5] = { T7, T2, A11, T3, T2,  };
