...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[3] = { A9, A10, A14,  };
		...
		case T2: {
			const enum vertices next[3] = { A12, A12, A10,  };
		...
		case T3: {
			const enum vertices next[6] = { A13, T2, A11, A13, T0, A9,  };
		...
		case T4: {
			const enum vertices next[3] = { A9, A11, T3,  };
		...
		case T5: {
			const enum vertices next[4] = { T0, A9, A11, T3,  };
		...
		case T7: {
			const enum vertices next[3] = { T6, T5, A11,  };
