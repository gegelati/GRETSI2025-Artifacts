...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[4] = { A12, A12, A9, A9,  };
		...
		case T1: {
			const enum vertices next[3] = { A12, T0, A9,  };
		...
		case T3: {
			const enum vertices next[5] = { A9, A11, A12, T2, A10,  };
		...
		case T4: {
			const enum vertices next[2] = { T3, A8,  };
		...
		case T5: {
			const enum vertices next[4] = { A7, T3, T4, A10,  };
		...
		case T6: {
			const enum vertices next[4] = { A13, T5, T3, A7,  };
