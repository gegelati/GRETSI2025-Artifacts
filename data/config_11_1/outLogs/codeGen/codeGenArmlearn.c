...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[3] = { A18, A15, A17,  };
		...
		case T1: {
			const enum vertices next[3] = { A15, A18, A21,  };
		...
		case T2: {
			const enum vertices next[2] = { T0, A18,  };
		...
		case T4: {
			const enum vertices next[6] = { A19, A16, A18, A18, A15, A21,  };
		...
		case T5: {
			const enum vertices next[5] = { A19, A21, A18, A16, A15,  };
		...
		case T6: {
			const enum vertices next[5] = { A20, T2, A18, A21, A19,  };
		...
		case T7: {
			const enum vertices next[4] = { T4, A20, A15, A19,  };
		...
		case T9: {
			const enum vertices next[7] = { A20, T5, A21, A19, T1, A20, A20,  };
		...
		case T10: {
			const enum vertices next[3] = { T3, T8, T1,  };
		...
		case T11: {
			const enum vertices next[3] = { T4, A15, T9,  };
		...
		case T12: {
			const enum vertices next[4] = { T9, T10, T7, T1,  };
		...
		case T13: {
			const enum vertices next[5] = { T11, T12, T3, A16, T9,  };
		...
		case T14: {
			const enum vertices next[3] = { T13, A16, T3,  };
