...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[5] = { A15, A13, T0, A15, A15,  };
		...
		case T2: {
			const enum vertices next[3] = { T1, A15, A13,  };
		...
		case T3: {
			const enum vertices next[4] = { T1, A10, A15, A14,  };
		...
		case T4: {
			const enum vertices next[4] = { A12, A16, A15, A14,  };
		...
		case T5: {
			const enum vertices next[7] = { A11, T4, A11, T2, A11, T2, A11,  };
		...
		case T6: {
			const enum vertices next[4] = { T3, A12, A11, A10,  };
		...
		case T7: {
			const enum vertices next[4] = { A11, A10, T5, A11,  };
		...
		case T8: {
			const enum vertices next[2] = { A12, T7,  };
		...
		case T9: {
			const enum vertices next[5] = { T8, A12, T3, T5, T6,  };
