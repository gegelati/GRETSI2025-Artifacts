...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[2] = { A15, A8,  };
		...
		case T2: {
			const enum vertices next[4] = { A15, A11, A8, A13,  };
		...
		case T3: {
			const enum vertices next[4] = { A11, T1, T2, A14,  };
		...
		case T4: {
			const enum vertices next[5] = { A12, A11, T1, T2, A14,  };
		...
		case T5: {
			const enum vertices next[5] = { A11, T3, T2, A14, A12,  };
		...
		case T6: {
			const enum vertices next[3] = { T4, A12, T0,  };
		...
		case T7: {
			const enum vertices next[3] = { T6, A10, T5,  };
