...
int inferenceTPG() {
	...
	while(1) {
		...
		case T1: {
			const enum vertices next[3] = { A12, A9, A11,  };
		...
		case T2: {
			const enum vertices next[2] = { A8, A15,  };
		...
		case T3: {
			const enum vertices next[3] = { A14, A8, T1,  };
		...
		case T4: {
			const enum vertices next[3] = { T2, T3, A14,  };
		...
		case T7: {
			const enum vertices next[6] = { A13, A15, T1, T6, A8, T6,  };
