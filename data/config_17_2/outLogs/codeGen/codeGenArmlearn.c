...
int inferenceTPG() {
	...
	while(1) {
		...
		case T2: {
			const enum vertices next[2] = { A11, A17,  };
		...
		case T3: {
			const enum vertices next[5] = { A11, A15, T2, A15, A13,  };
		...
		case T4: {
			const enum vertices next[3] = { T2, A17, A11,  };
		...
		case T6: {
			const enum vertices next[3] = { T5, A13, A11,  };
		...
		case T7: {
			const enum vertices next[3] = { T5, A15, A16,  };
		...
		case T8: {
			const enum vertices next[7] = { A11, A18, T0, T7, T4, A16, A15,  };
		...
		case T9: {
			const enum vertices next[3] = { A16, T6, T5,  };
