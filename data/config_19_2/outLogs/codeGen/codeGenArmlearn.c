...
int inferenceTPG() {
	...
	while(1) {
		...
		case T2: {
			const enum vertices next[2] = { A7, T1,  };
		...
		case T3: {
			const enum vertices next[4] = { A10, A9, A9, A13,  };
		...
		case T4: {
			const enum vertices next[4] = { A9, A8, T1, A9,  };
		...
		case T5: {
			const enum vertices next[6] = { T0, A7, T2, T4, T1, T2,  };
		...
		case T6: {
			const enum vertices next[3] = { T3, T5, T4,  };
