...
int inferenceTPG() {
	...
	while(1) {
		...
		case T0: {
			const enum vertices next[5] = { A12, A9, A11, A8, A10,  };
		...
		case T1: {
			const enum vertices next[4] = { A7, T0, A12, A9,  };
		...
		case T2: {
			const enum vertices next[3] = { A13, T1, T1,  };
		...
		case T3: {
			const enum vertices next[3] = { T1, A13, T1,  };
		...
		case T5: {
			const enum vertices next[5] = { A13, A8, A13, T4, A12,  };
